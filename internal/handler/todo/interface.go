...
type TodoServicer interface {
	...
	AddTask(ctx context.Context, task *models.TaskInput, userID *uuid.UUID) (*models.Task, error)
	DeleteTask(ctx context.Context, id string, userID *uuid.UUID) error
	UpdateTask(ctx context.Context, id string, task *models.TaskInput, isDone bool, userID *uuid.UUID) (*models.Task, error)
