...
func (m *MockStorer) RegisterUser(ctx context.Context, data *models.UserData) (*models.LoginSession, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStorerMockRecorder) RegisterUser(ctx, data interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RegisterUser", reflect.TypeOf((*MockStorer)(nil).RegisterUser), ctx, data)
}
...
// RegisterUser mocks base method.
func (m *MockUserStorer) RegisterUser(ctx context.Context, data *models.UserData) (*models.LoginSession, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RegisterUser", ctx, data)
	ret0, _ := ret[0].(*models.LoginSession)
	ret1, _ := ret[1].(error)
...
// Create mocks base method.
func (m *MockTodoStorer) Create(ctx context.Context, id, title string) (*models.Task, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", ctx, id, title)
	ret0, _ := ret[0].(*models.Task)
	ret1, _ := ret[1].(error)
...
// Create indicates an expected call of Create.
func (mr *MockTodoStorerMockRecorder) Create(ctx, id, title interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockTodoStorer)(nil).Create), ctx, id, title)
}

// Delete mocks base method.
func (m *MockTodoStorer) Delete(ctx context.Context, id string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", ctx, id)
	ret0, _ := ret[0].(error)
	return ret0
...
// Delete indicates an expected call of Delete.
func (mr *MockTodoStorerMockRecorder) Delete(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockTodoStorer)(nil).Delete), ctx, id)
}

// GetAll mocks base method.
func (m *MockTodoStorer) GetAll(ctx context.Context) ([]models.Task, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", ctx)
	ret0, _ := ret[0].([]models.Task)
	ret1, _ := ret[1].(error)
...
// GetAll indicates an expected call of GetAll.
func (mr *MockTodoStorerMockRecorder) GetAll(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAll", reflect.TypeOf((*MockTodoStorer)(nil).GetAll), ctx)
}

// MarkDone mocks base method.
func (m *MockTodoStorer) MarkDone(ctx context.Context, id string) (*models.Task, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MarkDone", ctx, id)
	ret0, _ := ret[0].(*models.Task)
	ret1, _ := ret[1].(error)
...
// MarkDone indicates an expected call of MarkDone.
func (mr *MockTodoStorerMockRecorder) MarkDone(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MarkDone", reflect.TypeOf((*MockTodoStorer)(nil).MarkDone), ctx, id)
}

// Update mocks base method.
func (m *MockTodoStorer) Update(ctx context.Context, id, title string) (*models.Task, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, id, title)
	ret0, _ := ret[0].(*models.Task)
	ret1, _ := ret[1].(error)
...
// Update indicates an expected call of Update.
func (mr *MockTodoStorerMockRecorder) Update(ctx, id, title interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockTodoStorer)(nil).Update), ctx, id, title)
}
