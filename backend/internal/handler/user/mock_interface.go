...
//
//	mockgen --source=interface.go --destination=mock_interface.go --package=userhttp
//
...
func (m *MockUserServicer) Login(ctx context.Context, req *models.LoginReq) (*models.AuthUserResp, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Login", ctx, req)
	ret0, _ := ret[0].(*models.AuthUserResp)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Login indicates an expected call of Login.
func (mr *MockUserServicerMockRecorder) Login(ctx, req any) *gomock.Call {
...
func (mr *MockUserServicerMockRecorder) Logout(ctx, token any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Logout", reflect.TypeOf((*MockUserServicer)(nil).Logout), ctx, token)
}

// Register mocks base method.
func (m *MockUserServicer) Register(ctx context.Context, req *models.LoginReq) error {
	m.ctrl.T.Helper()
...
func (mr *MockUserServicerMockRecorder) Register(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
